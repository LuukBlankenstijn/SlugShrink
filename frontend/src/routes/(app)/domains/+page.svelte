		...
		<table class="w-full table-fixed divide-y divide-white/10 text-sm">
			<thead class="bg-white/3">
				<tr class="text-left text-xs font-semibold tracking-wide text-slate-300 uppercase">
					<th class="w-[10%] px-4 py-3">Name</th>
					...
					<tr class="group hover:bg-white/4">
						<td class="px-4 py-3">
							<span class="inline-flex max-w-full items-center gap-2">
								<span class="block max-w-full truncate text-slate-200" title={d.name}>
									{d.name}
								</span>
							</span>
						</td>
						<td class="px-4 py-3">
							<span class="inline-flex max-w-full items-center gap-2">
								<span class="block max-w-full truncate text-slate-200" title={d.domain}>
									{d.domain}
								</span>
							</span>
						</td>
